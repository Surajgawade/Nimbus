      ...
      <div class="col-md-12">
         <div class="card" data-select2-id="9">
            <div class="card-body" data-select2-id="8">
              <form name="add_category" id="add_category" method="post" action="javascript:void(0)" enctype="multipart/form-data">
                  {{csrf_field()}}
                  ...
                  <div class="box-body">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <button type="submit" id="btn_add_category" name="btn_add_category" class="btn btn-primary">Submit</button>
...
$("#add_category").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        ...
        url: '<?php echo ADMIN_SITE_URL . 'create-category'; ?>',
        type: "POST",
        ...
        dataType:'json',
        beforeSend:function(){
          $('#btn_add_category').attr('disabled','disabled');
          $('#btn_add_category').html('Please Wait...');
        },
        complete:function(){
          $('#btn_add_category').attr('disabled',false);
          $('#btn_add_category').html('Submit');
        },
