                        ...
                        <div class="card card-table">
                            <div class="card-body">
                                <div class="table-responsive">
                                   <table id="tbl_datatable_category" class="table table-stripped table-hover"  style="width: 100%;">
...
@push('scripts')
  ...
  <script>
    ...
    var oTable =   $('#tbl_datatable_category').DataTable( {
        "serverSide": true,
        "processing": true,
        "ordering": true,
        bSortable: true,
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo SITE_URL.SITE_FOLDER.'admin/category-list-view'; ?>',
        ...
        "columns":[{'data' :'id'},{'data' :'created_on'},{"data":"category_name"},{"data":"status"}]

        } );


      $('#tbl_datatable_category tbody').on('dblclick', 'tr', function () { 
