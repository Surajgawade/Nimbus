      ...
      <div class="content container-fluid">
       <div class="page-header">
         <div class="row">
            <div class="col-sm-12">
              <h3 class="page-title">
                  <a href="{{route('sub-category.index')}}" style="margin-right: 10px;"><i class="fa fa-arrow-left" data-bs-toggle="tooltip" title="" data-bs-original-title="Back" aria-label="fa fa-arrow-left"></i></a>
                  Add Sub Category
               </h3>
               <ul class="breadcrumb">
      ...
      <div class="col-md-12">
         <div class="card" data-select2-id="9">
            <div class="card-body" data-select2-id="8">
              <form name="add_sub_category" id="add_sub_category" method="post" action="javascript:void(0)" enctype="multipart/form-data">
                  {{csrf_field()}}
                  ...
                  <div class="row" data-select2-id="6">
                    ...
                    <div class="col-sm-4 col-xs-4 col-lg-4 form-group">
                      ...
                      <input type="text" name="sub_category_name" id="sub_category_name" value="" class="form-control">
                  ...
                  <div class="box-body">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <button type="submit" id="btn_sub_add_category" name="btn_sub_add_category" class="btn btn-primary">Submit</button>
...
$("#add_sub_category").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        ...
        url: '<?php echo ADMIN_SITE_URL . 'create-sub-category'; ?>',
        type: "POST",
        ...
        dataType:'json',
        beforeSend:function(){
          $('#btn_sub_add_category').attr('disabled','disabled');
          $('#btn_sub_add_category').html('Please Wait...');
        },
        complete:function(){
          $('#btn_sub_add_category').attr('disabled',false);
          $('#btn_sub_add_category').html('Submit');
        },
