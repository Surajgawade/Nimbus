            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <a href="{{route('child-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add Child Category"><i class="fas fa-plus"></i> Add Child Category</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card card-table">
                            <div class="card-body">
                                <div class="table-responsive">
                                   <table id="tbl_datatable_child_category" class="table table-stripped table-hover"  style="width: 100%;">
...
@push('scripts')
  ...
  <script>
    ...
    var oTable =   $('#tbl_datatable_child_category').DataTable( {
        "serverSide": true,
        "processing": true,
        "ordering": true,
        bSortable: true,
        ...
        "ajax": $.fn.dataTable.pipeline( {
            url: '<?php echo SITE_URL.SITE_FOLDER.'admin/child-category-list-view'; ?>',
        ...
        "columns":[{'data' :'id'},{'data' :'created_on'},{"data":"category_name"},{"data":"sub_category_name"},{"data":"child_category_name"},{"data":"status"}]

        } );


      $('#tbl_datatable_child_category tbody').on('dblclick', 'tr', function () { 
